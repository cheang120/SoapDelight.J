...
const actionTypeOptions = [
  ...
  { value: "inventory.location_created", label: "新增存貨地點" },
  { value: "inventory.location_updated", label: "編輯存貨地點" },
  { value: "inventory.mapping_updated", label: "更新商品存貨地點設定" },
  { value: "inventory.initial_balance_set", label: "設定初始庫存" },
  { value: "inventory.production_in", label: "製作入庫" },
  { value: "inventory.adjusted", label: "庫存調整" },
  { value: "inventory.transferred", label: "庫存轉移" },
  { value: "consignment.delivery_created", label: "新增寄售出貨單" },
  { value: "consignment.delivery_updated", label: "編輯寄售出貨單" },
  { value: "consignment.delivery_issued", label: "發出寄售出貨單" },
  { value: "consignment.delivery_cancelled", label: "取消寄售出貨單" },
  { value: "consignment.delivery_return_created", label: "建立寄售退回" },
  { value: "consignment.report_created", label: "新增寄售報告" },
  { value: "consignment.report_updated", label: "編輯寄售報告" },
  { value: "consignment.report_confirmed", label: "確認寄售報告" },
  { value: "shipping_method.created", label: "新增送貨方式" },
  { value: "shipping_method.updated", label: "編輯送貨方式" },
  { value: "shipping_method.deleted", label: "刪除送貨方式" },
  { value: "company_profile.updated", label: "更新商戶資料" },
  { value: "campaign.created", label: "新增推廣電郵" },
  { value: "campaign.updated", label: "編輯推廣電郵" },
  { value: "campaign.test_sent", label: "發送測試推廣電郵" },
  { value: "campaign.sent", label: "發送推廣電郵" },
  { value: "campaign.deleted", label: "刪除推廣電郵" },
];
...
const targetTypeOptions = [
  ...
  { value: "InventoryLocation", label: "存貨地點" },
  { value: "ProductLocationMapping", label: "商品存貨地點設定" },
  { value: "InventoryBalance", label: "庫存結餘" },
  { value: "StockMovement", label: "庫存移動" },
  { value: "ConsignmentDelivery", label: "寄售出貨單" },
  { value: "ConsignmentDeliveryReturn", label: "寄售退回" },
  { value: "ConsignmentReport", label: "寄售報告" },
  { value: "ShippingMethod", label: "送貨方式" },
  { value: "CompanyProfile", label: "商戶資料" },
  { value: "Campaign", label: "推廣電郵" },
];
